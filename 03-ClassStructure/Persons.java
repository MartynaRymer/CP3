...
public class Persons{
    public static void main(String args[]) {
        Person PersonOne = new Person("Jan");
        Person PersonTwo = new Person("Hanna",55,1.78);
        Person PersonThree = new Person("Stefan",83,1.77);
    
        PersonOne.setWeightAndHeight(70,1.82);
        PersonOne.displayRecord();
        PersonTwo.displayRecord();
        PersonThree.displayRecord();
    }
}
